...
class Visual:
    ...
    * the placement of the body with respect to the joint frame.
    ...
    def place(self, gview, oMjoint, refresh=True):
        ...
        gview.applyConfiguration(self.name, se3ToXYZQUAT(oMbody))
    ...
    def jacobian(self, c2, robot, q):
        ...
        Ja = se3.jointJacobian(robot.model, robot.data, q, self.jointParent, WORLD, True)
        Jb = se3.jointJacobian(robot.model, robot.data, q, c2.jointParent, WORLD, True)
    ...
    def displayCollision(self, viewer, name='world/wa', refresh=True):
        viewer.setVisibility(name, 'ON')
        viewer.applyConfiguration(name, se3ToXYZQUAT(se3.SE3(self.R, self.w)))
        if refresh: viewer.refresh()
...
class Robot:
    ...
    * visuals: the list of all the 'visual' 3D objects to render the robot, each element of the list being
    ...
    def createHand(self, rootId=0, prefix='', jointPlacement=None):
        ...
        capsl = W
        try:
            self.viewer.addCapsule('world/' + prefix + 'wpalmb', capsr, capsl, color)
        except:
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'wpalmb', jointId, se3.SE3(rotate('x', pi / 2), zero(3)), capsr, capsl))
        capsr = H
        capsl = W
        try:
            self.viewer.addCapsule('world/' + prefix + 'wpalmt', capsr, capsl, color)
        except:
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'wpalmt', jointId, se3.SE3(rotate('x', pi / 2),
        ...
        try:
            ...
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'wpalml', jointId, se3.SE3(rotate('y', pi / 2),
        ...
        try:
            ...
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'wpalmr', jointId, se3.SE3(rotate('y', pi / 2),
                                                                  np.matrix([L / 2, W / 2, 0]).T), capsr, capsl))
        ...
        try:
            ...
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'palm2', jointId, se3.SE3(rotate('x', pi / 2), zero(3)), capsr, capsl))
        ...
        try:
            ...
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'finger11', jointId,
        ...
        try:
            ...
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'finger12', jointId,
                   se3.SE3(rotate('y', pi / 2),
                           np.matrix([FL / 2 - H, 0, 0]).T), capsr, capsl))
        ...
        try:
            ...
            pass
        self.visuals.append(Visual('world/' + prefix + 'finger13', jointId, trans(2 * H, 0, 0), capsr, capsl))
        ...
        try:
            ...
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'finger21', jointId,
                   se3.SE3(rotate('y', pi / 2),
                           np.matrix([FL / 2 - H, 0, 0]).T), capsr, capsl))
        ...
        try:
            ...
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'finger22', jointId,
                   se3.SE3(rotate('y', pi / 2),
                           np.matrix([FL / 2 - H, 0, 0]).T), capsr, capsl))
        ...
        try:
            ...
            pass
        self.visuals.append(Visual('world/' + prefix + 'finger23', jointId, trans(H, 0, 0), capsr, capsl))
        ...
        try:
            ...
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'finger31', jointId,
                   se3.SE3(rotate('y', pi / 2),
                           np.matrix([FL / 2 - H, 0, 0]).T), capsr, capsl))
        ...
        try:
            ...
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'finger32', jointId,
                   se3.SE3(rotate('y', pi / 2),
                           np.matrix([FL / 2 - H, 0, 0]).T), capsr, capsl))
        ...
        try:
            ...
            pass
        self.visuals.append(Visual('world/' + prefix + 'finger33', jointId, trans(2 * H, 0, 0), capsr, capsl))
        ...
        try:
            ...
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'thumb1', jointId,
                   se3.SE3(rotate('z', pi / 3) * rotate('x', pi / 2),
        ...
        try:
            ...
            pass
        self.visuals.append(
            Visual('world/' + prefix + 'thumb2', jointId,
                   se3.SE3(rotate('x', pi / 3),
                           np.matrix([-0.7 * cm, .8 * cm, -0.5 * cm]).T), capsr, capsl))
    ...
    def displayCollision(self, pairIndex, meshIndex, onlyOne=False):
        ...
        self.viewer.setVisibility('world/wa' + str(meshIndex), 'ON')
        self.viewer.setVisibility('world/wb' + str(meshIndex), 'ON')

    def display(self, q):
        se3.forwardKinematics(self.model, self.data, q)
        for visual in self.visuals:
            visual.place(self.viewer, self.data.oMi[visual.jointParent], refresh=False)
        self.viewer.refresh()
